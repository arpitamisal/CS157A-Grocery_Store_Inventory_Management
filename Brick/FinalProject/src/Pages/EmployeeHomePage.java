...
public class EmployeeHomePage {
	...
	public EmployeeHomePage(Stage primaryStage) {
		...
		manageProductButton.setOnAction(e -> {			
			...
			primaryStage.setScene(new Scene(manageP.getRoot(), 600, 600));
		...
		trackInventoryButton.setOnAction(e -> {			
			...
			primaryStage.setScene(new Scene(trackInv.getRoot(), 600, 600));
		...
		viewCustomerInfoButton.setOnAction(e -> {					
			...
			primaryStage.setScene(new Scene(viewCustInfo.getRoot(), 600, 600)); // create instance of expiredWarrantyAsset class
