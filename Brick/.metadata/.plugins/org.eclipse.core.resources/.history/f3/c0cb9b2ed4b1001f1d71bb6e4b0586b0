...
public class ViewCustomerInformation {
	...
	public ViewCustomerInformation(Stage primaryStage) {
		...
		Button createDiscountsButton = new Button("View Customer Profiles");
		Button updateDiscountsButton = new Button("Update Customer Profiles");
		Button returnToHomePageButton = new Button("Return to Homepage");
		
		// add the button to the HBox and align the HBox to the center
		buttons.getChildren().addAll(createDiscountsButton, updateDiscountsButton);
