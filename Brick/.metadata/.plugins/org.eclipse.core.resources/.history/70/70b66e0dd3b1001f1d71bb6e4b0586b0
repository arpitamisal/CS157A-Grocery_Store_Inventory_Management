...
public class ProcessOrders {
	...
	public ProcessOrders(Stage primaryStage) {
		...
		Button updateStockQuantityButton = new Button("Update Order Status");
		...
		buttons.getChildren().addAll(viewCustomerOrdersButton, updateStockQuantityButton, setReorderLevelsButton);
